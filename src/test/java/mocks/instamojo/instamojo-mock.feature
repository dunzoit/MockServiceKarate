...
Feature: Instamojo mock for automation
  ...
  Scenario: pathMatches('/payment-requests/') && methodIs('post')
    ...
    * def randomPaymentId = getRandomUuid()
    * def long_temp_url = 'https://test.instamojo.com/@tasneem/'+ randomPaymentId
